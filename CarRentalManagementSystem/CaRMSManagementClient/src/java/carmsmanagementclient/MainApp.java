            ...
            while(response < 1 || response > 2)
            {
                ...
                if(response == 1)
                {
                    try
                    {
                        ...
                        operationsManagerModule = new OperationsManagerModule(currentEmployee, carSessionBeanRemote, carCategorySessionBeanRemote, modelSessionBeanRemote, outletSessionBeanRemote);
